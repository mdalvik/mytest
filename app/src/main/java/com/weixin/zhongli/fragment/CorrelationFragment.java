...
public class CorrelationFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.fragment_correlation, null);
        initData();
        initView();
        initPUll();
        initEvent();
    ...
    private void initView() {
        lv_tontant = (ListView) view.findViewById(R.id.correlation_lv_tontant);
        ...
        for (int i=0;i<10;i++){
            if (i%3==0){
                picList.add("http://img0.imgtn.bdimg.com/it/u=2013819174,1049816796&fm=206&gp=0.jpg");
            }else if (i%3==1){
                picList.add("http://pic1.nipic.com/2008-10-20/20081020104257376_2.jpg");
            }else if(i%3==2){
